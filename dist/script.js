(() => {
  function init() {
    ...
    hamburger.addEventListener("click", () => {
      hamburgerClickable(nav, hamburger, menuLi, scrollTopButton);
    });
  ...
  function hamburgerClickable(nav, hamburger, menuLi, scrollTopButton) {
    ...
    function myFunction(x) {
      if (x.matches && hamburger.classList.contains("active")) {
  ...
  function activeForm() {
    ...
    let contactButton = document.querySelectorAll(
      ".company__employee > button"
    );
